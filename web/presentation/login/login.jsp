...
<html>
    ...
    <body>
        ...
        <form class="formulario" action="presentation/login/login" method="post">
...
<%! 
    ...
    private Map<String,String[]> getForm(ModelLogin model){
       ...
       values.put("id", new String[]{"cedula"});
       values.put("password", new String[]{"pass"});
       return values;
    }
